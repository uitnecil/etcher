...
const storeReducer = (state = DEFAULT_STATE, action) => {
  switch (action.type) {
    ...
    case ACTIONS.SELECT_IMAGE: {
      ...
      const extension = action.data.extension.toLowerCase()
      ...
      lastImageExtension = _.isString(lastImageExtension) ? lastImageExtension.toLowerCase() : lastImageExtension
      ...
      if (lastImageExtension !== extension) {
        ...
        const archiveExtension = action.data.archiveExtension.toLowerCase()
